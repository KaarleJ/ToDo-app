...
public class TodoQueryBuilder {
  public CriteriaQuery<ToDo> buildToDoQuery(String authId, Boolean status, String search, CriteriaBuilder cb,
      EntityManager entityManager, Pageable pageable) {
  ...
  public CriteriaQuery<Long> buildCountQuery(String authId, Boolean status, String search, CriteriaBuilder cb,
